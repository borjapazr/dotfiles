# Generated by Powerlevel10k configuration wizard on 2022-03-12 at 00:30 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # wifi                  # wifi speed
    arch                    # example user-defined segment (see prompt_friend function below)
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_CONTENT_EXPANSION='${$((my_git_formatter(1)))+${my_git_format}}'
  ...
  # typeset -g POWERLEVEL9K_ARCH_FOREGROUND=208
  # typeset -g POWERLEVEL9K_ARCH_VISUAL_IDENTIFIER_EXPANSION='⭐'
